...
const pageTitle = ref('Orly'); // Browser tab title
// Ensure posteTravailQuestionId is defined for the template
const posteTravailQuestionId = 'LOCALISATION'; // 🎯 Change this if your work station question has a different ID
const customWelcomeMessage = ref(`
  Bonjour,<br> <br>pour mieux connaître les usagers de la gare de Thiais-Orly,<br><br> la Ville ainsi qu’ IDFM souhaiteraient en savoir plus sur votre déplacement en cours.<br><br> Auriez-vous quelques secondes à nous accorder ? 
